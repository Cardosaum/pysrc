...
def openImgOcl():
    ...
    if imgOclWindow:
        ...
        while True:
            try:
                mcs.normalizePath()
                pyautogui.locateOnScreen(abspath('././imgtlf/2019-07-26_12-13-24_1564154004_flameshot.png'), grayscale=True)
                break
            except:
                sleep(0.2)
                continue
        ...
        while True:
            try:
                buttFit = pyautogui.center(pyautogui.locateOnScreen(abspath('././imgtlf/2019-07-25_12-08-46_1564067326_flameshot.png'), grayscale=True))
                pyautogui.click(buttFit[0], buttFit[1])
                break
            except:
                pass
            try:
                buttFit = pyautogui.center(pyautogui.locateOnScreen(abspath('././imgtlf/2019-07-25_13-38-16_1564072696_flameshot.png'), grayscale=True))
                pyautogui.click(buttFit[0], buttFit[1])
                break
            except:
                pass
...
if gthumbWindow:
    if addWindow:
        if activeWindow() == 'gThumb':
            ...
            while True:
                try:
                    pyautogui.locateOnScreen(abspath('././imgtlf/2019-07-26_11-52-19_1564152739_flameshot.png'), grayscale=True)
                    break
                except:
                    sleep(0.2)
                    continue
